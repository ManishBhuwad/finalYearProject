...
import com.example.manishproject.Mess_Order_Dishes;
...
//    private APIService apiService;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.mess_order, parent, false);
                ...
                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                            ...
                            String messid = messPendingOrders.getChefId();
                            String dishid = messPendingOrders.getDishId();
                            hashMap.put("MessId", messPendingOrders.getChefId());
                            ...
                            FirebaseDatabase.getInstance().getReference("ChefPaymentOrders").child(messid).child(random).child("Dishes").child(dishid).setValue(hashMap);
                        }
                                        ...
                                        Reference.addListenerForSingleValueEvent(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                ...
                                                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                                                    ...
                                                    hashMap2.put("MessId", messPendingOrders.getChefId());
...
//                                                                                                        sendNotifications(usertoken, "Order Accepted", "Your Order has been Accepted by the Chef, Now make Payment for Order", "Payment");
                                                                                                        ReusableCode.ShowAlert(context,"","Wait for the Customer to make Payment");
