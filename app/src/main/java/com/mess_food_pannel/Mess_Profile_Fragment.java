...
import com.example.manishproject.Mess_PostDish;
import com.example.manishproject.R;

public class Mess_Profile_Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_mess_profile, container, false);
