...
public class UserOnlinePayment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_online_payment);
        ...
        Addcard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (valid()) {
                    Intent intent = new Intent(UserOnlinePayment.this, UserPaymentOTP.class);
