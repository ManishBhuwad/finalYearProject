...
public class DeliveryShipOrders {
    ...
    public DeliveryShipOrders(String messId, String dishId, String dishName, String dishPrice, String dishQuantity, String randomUID, String totalPrice, String userId) {
        MessId = messId;
        DishId = dishId;
        DishName = dishName;
        DishPrice = dishPrice;
