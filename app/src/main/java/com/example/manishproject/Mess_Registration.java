    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        statespin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (statee.equals("Maharashtra")) {
                    ...
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Mess_Registration.this, android.R.layout.simple_spinner_item, list);
        ...
        Cityspin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (cityy.equals("Mumbai")) {
                    ...
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Mess_Registration.this, android.R.layout.simple_spinner_item, listt);
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isValid()) {
                    ...
                    final ProgressDialog mDialog = new ProgressDialog(Mess_Registration.this);
                            ...
                            if (task.isSuccessful()) {
                                ...
                                databaseReference.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        firebaseDatabase.getInstance().getReference("Mess")
                                                ...
                                                .setValue(hashMappp).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        ...
                                                        FAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                            ...
                                                            public void onComplete(@NonNull Task<Void> task) {
                                                                if (task.isSuccessful()) {
                                                                    AlertDialog.Builder builder = new AlertDialog.Builder(Mess_Registration.this);
                                                                    ...
                                                                    builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                                                        ...
                                                                        public void onClick(DialogInterface dialog, int which) {
                                                                            ...
                                                                            Intent b = new Intent(Mess_Registration.this, MessPhoneVerify.class);
                                                                    ...
                                                                    mDialog.dismiss();
                                                                    ReusableCode.ShowAlert(Mess_Registration.this, "Error", task.getException().getMessage());
        ...
        Emaill.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Mess_Registration.this, Mess_login.class);
                startActivity(i);
                finish();
            }
        });
        ...
        Phone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent e = new Intent(Mess_Registration.this, Mess_login.class);
                startActivity(e);
                finish();
            }
        });
