...
import com.User_food_Pannel.UserForgotPassword;
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        ...
                                        user.updatePassword(ne).addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                if (task.isSuccessful()) {
                                                    ...
                                                    Toast.makeText(UserPassword.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                                                }
                                            }
                                        });
                                    } else {
                ...
                forgot.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent aa=new Intent(UserPassword.this, UserForgotPassword.class);
                        startActivity(aa);
                    }
                });
