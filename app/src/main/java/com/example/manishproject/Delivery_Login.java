...
public class Delivery_Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                if (FAuth.getCurrentUser().isEmailVerified()) {
                                    ...
                                    ReusableCode.ShowAlert(Delivery_Login.this, "", "Please Verify your Email");
                                }

                            } else {

                                mDialog.dismiss();
                                ReusableCode.ShowAlert(Delivery_Login.this, "Error", task.getException().getMessage());
                            }
                        }
                    });
                }
        ...
        Signinphone.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent q = new Intent(Delivery_Login.this, Delivery_Phone_login.class);
                startActivity(q);
                finish();
            }
        });
